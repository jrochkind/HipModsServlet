...
<!-- changed by csd to fix encoding errors -->
<xsl:output method="xml" indent="yes" encoding="UTF-8"/>
	...
	<xsl:template match="/">
		<xsl:choose>
			<xsl:when test="marc:collection">
				<modsCollection xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.loc.gov/standards/mods/v3/mods-3-0.xsd">
